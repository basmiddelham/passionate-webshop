<nav class="shopnav widget d-flex justify-content-center flex-wrap mb-3">
	<a class="shopnav-item nav-jj" href="<?php echo get_home_url(); ?>/jongejury">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/dist/images/nav-jj-25.png" srcset="<?php echo get_template_directory_uri(); ?>/assets/dist/images/nav-jj-25@2x.png 2x" width="94" height="70" alt="Jonge Jury">
	</a>
