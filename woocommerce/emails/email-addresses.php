	...
	<tr>
		<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; border:0; padding:0;" valign="top" width="50%">
			...
			<address class="address">
				...
				$billing_middle_name = get_post_meta( $order->get_id(), '_billing_middle_name', true );

				if ( $raw_address['company'] ) {
					echo esc_html( $raw_address['company'] ) . '<br/>';
				}
				echo esc_html( $raw_address['first_name'] ) . ' ';
				if ( $billing_middle_name ) {
					echo esc_html( $billing_middle_name ) . ' ';
				}
				echo esc_html( $raw_address['last_name'] ) . '<br/>';
				echo esc_html( $raw_address['address_1'] ) . ' ';
				echo esc_html( $raw_address['address_2'] ) . '<br/>';
				echo esc_html( $raw_address['postcode'] ) . ' ';
				echo esc_html( $raw_address['city'] );
				?>
